<div id="messaggioCC" <?php if(@$fields['modalita_pagamento'] == 'pagamento_cc') { echo ' class="visibile"';} ?>>
Per la modalità di pagamento da lei scelta "Carta di Credito", a seguito della ricezione del suo Codice Cliente, che avverrà entro qualche giorno dal ricevimento del contratto da parte di Terrecablate, la invitiamo a registrasi sul portale Terrecablate e ad inserire le informazioni circa la carta di credito da associare al suo contratto. La informiamo che in assenza di tali informazioni Terrecablate non potrà procedere con l'attivazione dei servizi richiesti.
</div>
...
<fieldset id="fields-modulo-A">
	...
	<div class="form-group col-md-6">
		<label for="sdd_debitore_nome">Cognome e Nome *</label>
	...
	<div class="form-group col-md-6">
		<label for="sdd_debitore_cf_piva">Codice Fiscale *</label>
	...
	<div class="form-group col-md-6">
		<label for="sdd_titolare_cf_piva">Codice Fiscale </label>
