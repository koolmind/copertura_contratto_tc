<?php 
/* 
 * Template part > form Residenziale MyHome Voce
 */
?>
<section id="main-content">
	<div class="container contratti-wrap contratti-R">
		<div class="row">
			<h1 class="fontdin">MyHome Voce <small>- PROPOSTA DI CONTRATTO PER LA TUA CASA</small></h1>
			...
			<form class="form form-horizontal form-contratto" id="frm-contratto" method="post" data-url ="<?php echo admin_url('admin-ajax.php');?>">
				...
				<fieldset id="fields-prodotti-servizi-richiesti">
					...
					<div class="clearfix sub-section">
						...
						<div class="col-md-4">
							<i class="fa fa-check" aria-hidden="true"></i><strong>MyHome VOCE</strong>
						</div>
					</div>
				...
				<input type="hidden" name="dati[offerta_selezionata]" id="offerta_selezionata" value="myhomevoce">
