...
<section id="main-content">
	...
	<div class="container contratti-wrap contratti-A contratto-riepilogo">
		<div class="row">
			...
			<section class="clearfix">
				<h3>8. Manifestazione di consenso al trattamento dei dati personali ( D.Lgs.196/2003)</h3>
				<p>In relazione all'Informativa riportata nell’allegato al presente Documento di Accettazione “Informativa sul trattamento dei dati personali (D.Lgs.196 del 30 giugno 2003)”, prendo
atto che i dati personali fornitivi vengano trattati, diffusi e comunicati anche a terzi, anche all'estero, per lo svolgimento degli adempimenti relativi alle fnalità di cui al punto 1) e 2) dell’informativa e do il consenso alle predette comunicazioni ed ai relativi trattamenti. Sono inoltre consapevole che, in mancanza del mio consenso al trattamento, alla comunicazione e diffusione di tali dati per le fnalità sopra indicate, non potrò aderire alla presente offerta. Per le fnalità specifcamente indicate al punto 3) dell’informativa do il consenso al trattamento,diffusione e comunicazione, anche a terzi, anche all’estero, dei dati personali fornitivi.<br/><i class="fa fa-check" aria-hidden="true"></i><strong>PRESTO IL CONSENSO</strong></p>

				<p>Autorizzo il trattamento dei miei dati personali a fini promozionali e/o commerciali.<br/>
