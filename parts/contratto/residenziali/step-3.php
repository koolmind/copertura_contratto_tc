    ...
    <fieldset id="fields-indirizzo-dispositivo" class="mt-3">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <input type="text" name="dati[servizi_note]" id="servizi_note" class="form-control tc-required"  maxlength="100" placeholder="nome sul campanello"  value="<?php tcGetFieldValue($fields,'servizi_note'); ?>">
